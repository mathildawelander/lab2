...
class KreditCardBack extends StatefulWidget {
 ...
 final Function callbackFunction;
  KreditCardBack(  this.cvv, {Key? key, required this.callbackFunction}) : super(key: key);
...
padding: EdgeInsets.fromLTRB(0, 0, 10, 0),
  child: Text("CVV", style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromARGB(255, 255, 249, 249), fontSize: 13)),
    ),
  Container(
...
alignment: Alignment.centerRight,
padding: EdgeInsets.fromLTRB(0, 0, 10, 0),
  child: Text(widget.cvv, style: TextStyle(color: Color.fromARGB(255, 0, 0, 0), fontSize: 15)),
    ),
  ],),
